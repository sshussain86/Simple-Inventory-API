...
using SimpleInventoryAPI.Standard.Models;
...
namespace SimpleInventoryAPI.Tests
{
    ...
    public class ControllerTestBase
    {
        ...
        private static SimpleInventoryAPIClient client;
        ...
        /// </summary>
        /// <returns></returns>
        public static SimpleInventoryAPIClient GetClient()
        {
            lock (clientSync)
            {
                if (client == null)
                {
                    client = new SimpleInventoryAPIClient();
                }
                return client;
            }
        }
